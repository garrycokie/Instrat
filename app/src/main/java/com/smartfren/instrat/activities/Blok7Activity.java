...
public class Blok7Activity extends BaseStepsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapterQ101 = ArrayAdapter.createFromResource(this, R.array.page_blok7_q101A_list, android.R.layout.simple_spinner_item);
        adapterQ101.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        _spQ101A.setAdapter(adapterQ101);

        if(extras.getString("NO_101") != null)
        {
            int position = SetSelectedSpinner(adapterQ101, extras.getString("NO_101"));
            if(position > 0) {
                _spQ101A.setSelection(position);
            }
        }

        if(extras.getString("NO_102") != null)
        {
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_samsung_text)))
            {
                _cbQ102ASamsung.setChecked(true);
            }
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_smartfren_text)))
            {
                _cbQ102ASmartfren.setChecked(true);
            }
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_advan_text)))
            {
                _cbQ102AAdvan.setChecked(true);
            }
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_lenovo_text)))
            {
                _cbQ102ALenovo.setChecked(true);
            }
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_oppo_text)))
            {
                _cbQ102AOppo.setChecked(true);
            }
            if(extras.getString("NO_102").contains(getResources().getString(R.string.page_checkbox_asus_text)))
            {
                _cbQ102AAsus.setChecked(true);
            }
        }
        ...
        super.setStepEventListener(new OnStepEventListener() {
            ...
            public void onBackClicked() {
                Intent intent = new Intent(Blok7Activity.this, Blok6Activity.class);
            ...
            public void onContinueClicked() {
                ...
                if(A102.equals("") || A102.isEmpty())
                {
                    ...
                    _errorQ102A.setText("pilih salah satu checkbox");
                }
                else
                {
