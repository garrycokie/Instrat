...
public class Blok10Activity extends BaseStepsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.initActivity(R.layout.activity_blok10);
        ...
        _error129A = (TextView) findViewById(R.id.error129A);
        ...
        super.setStepEventListener(new OnStepEventListener() {
            ...
            public void onContinueClicked() {
                ...
                if (_Q129Value == null || _Q129Value.equals("") || _Q129Value.isEmpty())
                {
                    _error129A.setError("error");
                    _error129A.setText("Salah satu checkbox harus dipilih");
                }

                else {

                    _error129A.setError(null);
                    _error129A.setText(null);
