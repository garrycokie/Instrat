...
public class Blok7BActivity extends BaseStepsActivity {
    ...
    private TextView _errorQ106A;
    private TextView _errorQ107A;
    private TextView _errorQ108A;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _errorQ106A = (TextView) findViewById(R.id.errorQ106A);
        _errorQ107A = (TextView) findViewById(R.id.errorQ107A);
        _errorQ108A = (TextView) findViewById(R.id.errorQ108A);

        Helper.Show(_cbQ108A1);
        Helper.Show(_cbQ108A2);
        Helper.Show(_cbQ108A3);
        Helper.Show(_cbQ108A4);
        Helper.Show(_cbQ108A5);
        Helper.Show(_cbQ108A6);
        Helper.Show(_cbQ108A7);
        Helper.Show(_cbQ108A8);
        Helper.Show(_cbQ108A9);
        Helper.Show(_cbQ108A10);
        Helper.Show(_cbQ108A11);
        Helper.Show(_cbQ108A12);
        Helper.Show(_cbQ108A13);
        Helper.Show(_cbQ108A14);
        Helper.Show(_cbQ108A15);

        _txtQ108A = (EditText) findViewById(R.id.txtQ108A);

        if(extras.getString("NO_106") != null && !extras.getString("NO_106").isEmpty() && !extras.getString("NO_106").equals(""))
        {
            if(extras.getString("NO_106").contains(getResources().getString(R.string.page_checkbox_blok7_supplier_distributor_smartfren_text)))
            {
                _cbQ106A1.setChecked(true);
            }
            if(extras.getString("NO_106").contains(getResources().getString(R.string.page_checkbox_blok7_supplier_wholesaler_text)))
            {
                _cbQ106A2.setChecked(true);
            }
            if(extras.getString("NO_106").contains(getResources().getString(R.string.page_checkbox_blok7_supplier_bandar_text)))
            {
                _cbQ106A3.setChecked(true);
            }
            if(extras.getString("NO_106").contains(getResources().getString(R.string.page_checkbox_blok7_supplier_toko_lain_text)))
            {
                _cbQ106A4.setChecked(true);
            }
            if(extras.getString("NO_106").contains(getResources().getString(R.string.page_checkbox_blok7_supplier_mall_lain_text)))
            {
                _cbQ106A5.setChecked(true);
            }
        }

        ArrayAdapter<CharSequence> adapterQ107 = ArrayAdapter.createFromResource(this, R.array.page_blok7_nextorder_list, R.layout.spinner_item);
        adapterQ107.setDropDownViewResource(R.layout.spinner_item);
        _spQ107A.setAdapter(adapterQ107);

        if(extras.getString("NO_107") != null && !extras.getString("NO_107").isEmpty() && !extras.getString("NO_107").equals(""))
        {
            int position = SetSelectedSpinner(adapterQ107, extras.getString("NO_107"));
            if(position > 0) {
                _spQ107A.setSelection(position);
            }
        }

        if(extras.getString("NO_108") != null && !extras.getString("NO_108").isEmpty() && !extras.getString("NO_108").equals(""))
        {
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_1_text)))
            {
                _cbQ108A1.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_2_text)))
            {
                _cbQ108A2.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_3_text)))
            {
                _cbQ108A3.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_4_text)))
            {
                _cbQ108A4.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_5_text)))
            {
                _cbQ108A5.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_6_text)))
            {
                _cbQ108A6.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_7_text)))
            {
                _cbQ108A7.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_8_text)))
            {
                _cbQ108A8.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_9_text)))
            {
                _cbQ108A9.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_10_text)))
            {
                _cbQ108A10.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_11_text)))
            {
                _cbQ108A11.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_12_text)))
            {
                _cbQ108A12.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_13_text)))
            {
                _cbQ108A13.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_14_text)))
            {
                _cbQ108A14.setChecked(true);
            }
            if(extras.getString("NO_108").contains(getResources().getString(R.string.page_checkbox_blok7_alasan_ragu_15_text)))
            {
                _cbQ108A15.setChecked(true);
            }

            String[] splitAnswer = extras.getString("NO_108").split(";");
        ...
        _spQ107A.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if(selectedItem.equals("Akan order lagi"))
                {
                    ...
                    Helper.Show(_cbQ108A6);
                    Helper.Show(_cbQ108A7);
                    Helper.Hide(_cbQ108A8);
                    Helper.Hide(_cbQ108A9);
                    Helper.Hide(_cbQ108A10);
                    Helper.Hide(_cbQ108A11);
                    Helper.Hide(_cbQ108A12);
                    Helper.Hide(_cbQ108A13);
                    Helper.Hide(_cbQ108A14);
                }
                ...
                {
                    Helper.Hide(_cbQ108A1);
                    Helper.Hide(_cbQ108A2);
                    Helper.Hide(_cbQ108A3);
                    Helper.Hide(_cbQ108A4);
                    Helper.Hide(_cbQ108A5);
                    Helper.Hide(_cbQ108A6);
                    Helper.Hide(_cbQ108A7);
                    Helper.Show(_cbQ108A8);
                    Helper.Show(_cbQ108A9);
                    Helper.Show(_cbQ108A10);
                    Helper.Show(_cbQ108A11);
        ...
        super.setStepEventListener(new OnStepEventListener() {
            ...
            public void onBackClicked() {
                ...
                if(product.contains("samsung"))
                {
                    Intent intent = new Intent(Blok7BActivity.this, Blok7AActivity.class);
                ...
                {
                    Intent intent = new Intent(Blok7BActivity.this, Blok7Activity.class);
                    intent.putExtra("DeviceSurveyID",extras.getString("DeviceSurveyID"));
                    intent.putExtra("TipeSurvey", extras.getString("TipeSurvey"));
                    intent.putExtra("UserID", extras.getString("UserID"));
                    intent.putExtra("AccessToken", extras.getString("AccessToken"));
            ...
            public void onContinueClicked() {
                ...
                if(A107.equals("--Pilih Jawaban--") || A107 == null || A107.equals("") || A107.isEmpty())
                {
                    _errorQ107A.setError("error");
                    _errorQ107A.setText("Pilih salah satu jawaban");
                }
                else
                {
                    _errorQ107A.setError(null);
                    _errorQ107A.setText("");
                    validatedAnswer++;
                }
                if(A106.equals("") || A106.isEmpty())
                {
                    _errorQ106A.setError("error");
                    _errorQ106A.setText("pilih salah satu checkbox");
                }
                else
                {
                    _errorQ106A.setError(null);
                    _errorQ106A.setText("");
                    validatedAnswer++;
                }

                if(A108 == null || A108.equals("") || A108.isEmpty())
                {
                    _errorQ108A.setError("error");
                    _errorQ108A.setText("pilih salah satu checkbox");
                }
                else if(_cbQ108A15.isChecked() && A108 != null && !A108.equals("") && !A108.isEmpty() && (_txtQ108A.getText() == null || _txtQ108A.getText().toString().equals("")) )
                {
                    _errorQ108A.setError("error");
                    _errorQ108A.setText("checkbox lainnya tercentang, textbox harus terisi");
                }
                else if(_cbQ108A15.isChecked() && A108 != null && !A108.equals("") && !A108.isEmpty() && _txtQ108A.getText().toString().length() > 50)
                {
                    _errorQ108A.setError("error");
                    _errorQ108A.setText("checkbox lainnya tercentang, textbox harus terisi tidak boleh lebih dari 50 karakter");
                }
                else
                {
                    _errorQ108A.setError(null);
                    _errorQ108A.setText("");
                    validatedAnswer++;
                }
                ...
                if(validatedAnswer == 3)
                {
                    ...
                    {
                        Intent intent = new Intent(Blok7BActivity.this, Blok8Activity.class);
                        intent.putExtra("DeviceSurveyID",extras.getString("DeviceSurveyID"));
                        intent.putExtra("TipeSurvey", extras.getString("TipeSurvey"));
                        intent.putExtra("UserID", extras.getString("UserID"));
                        intent.putExtra("AccessToken", extras.getString("AccessToken"));
